...
public class Adapter_Album extends RecyclerView.Adapter<Adapter_Album.myViewHolder> {
    ...
    public Adapter_Album(Context mContext, List<SingingGroup> mData) {
    ...
    public myViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.singing_group_item, parent, false);          //card item here
        ...
        public myViewHolder(View itemView) {
            ...
            btn_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(view.getContext(), Activity_SongList.class);
